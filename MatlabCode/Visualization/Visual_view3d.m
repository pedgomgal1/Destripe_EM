...
switch nargin
    ...
    case 2
        ...
        fig1 = figure;
        ax(1)=subplot(1,2,1); im1 = imagesc(img(:,:,slice)); colormap gray; axis image; title('original image');%caxis([0,255]);
        ax(2)=subplot(1,2,2); im2 = imagesc(real(rec(:,:,slice))); colormap gray; axis image; title('recovered image');%caxis([0,255]);
        linkaxes(ax,'xy');
